...
from src.models.efficient_net import H0_EfficientNetB7
...
def run(config):
    ...
    print("Validating model... on the validation set (dataver0 + dataver1 + dataver2_image + dataver2_patch)")
    # Validate model
    ...
    # Start validation
    validator.evaluate()
    print("Validation on the validation set (dataver0 + dataver1 + dataver2_image + dataver2_patch) completed.")
